...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-[-150px] w-[300px] h-[300px] bg-[var(--theme-primary)]/[0.04] rounded-full blur-[100px] pointer-events-none" />

      <div className="w-full max-w-md relative z-10">
        {/* Logo */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4 bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-secondary)] shadow-[0_0_40px_rgba(255,87,34,0.25)]">
            <span className="text-white font-bold text-2xl">CF</span>
          </div>
          <h1 className="text-2xl font-semibold text-[var(--theme-text)]">
            Cloth<span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-secondary)]">Fasion</span>{' '}
            Admin
          </h1>
          <p className="text-[var(--theme-text-muted)] text-sm mt-1">Sign in to manage your store</p>
        </div>
        ...
        <div className="bg-[var(--theme-card)] border border-white/[0.08] rounded-2xl p-8 shadow-[0_24px_80px_rgba(0,0,0,0.5)]">
            ...
            <TabsContent value="password">
              <form onSubmit={handlePasswordLogin} className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full h-11 bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-secondary)] hover:from-[#FF6D3B] hover:to-[#FF4466] text-white font-medium rounded-xl border-0 shadow-[0_4px_20px_rgba(255,87,34,0.3)] transition-all"
                >
            ...
            <TabsContent value="code">
              <form onSubmit={handleCodeLogin} className="space-y-6">
                ...
                <Button
                  ...
                  className="w-full h-11 bg-gradient-to-r from-[var(--theme-primary)] to-[var(--theme-secondary)] hover:from-[#FF6D3B] hover:to-[#FF4466] text-white font-medium rounded-xl border-0 shadow-[0_4px_20px_rgba(255,87,34,0.3)] transition-all disabled:opacity-50"
                >
                  {loading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                  Verify
                </Button>
          ...
          <div className="mt-6 p-3 bg-white/5 border border-white/[0.06] rounded-xl">
            <p className="text-xs text-[var(--theme-text-muted)] text-center">
              ...
              <span className="font-medium text-[var(--theme-text)]">admin123</span>
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-6">
          <a
            href="/"
            className="text-sm text-[var(--theme-text-muted)] hover:text-[var(--theme-text)] transition-colors inline-flex items-center gap-1"
          >
            &larr; Back to Store
          </a>
        </div>
